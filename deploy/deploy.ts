...
export default async function (hre: HardhatRuntimeEnvironment) {
  ...
  const artifact = await deployer.loadArtifact("SinkDrain");
...
//   const greeting = "Hi there!";
  ...
  const sinkDrainContract = await deployer.deploy(artifact, []);

  //obtain the Constructor Arguments
  console.log(
    "constructor args:" + sinkDrainContract.interface.encodeDeploy([]),
  );
